...
export default function AddBeehiveModal({ show, onHide, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axiosClient.post("kosnice", formData);
      alert("Beehive successfully added!");
      onSuccess();
      onHide();
      setFormData({
        oznaka: "",
      ...
      alert("Error adding beehive. Please check your input.");
    }
  };
    ...
    <Modal show={show} onHide={onHide} centered backdrop="static" keyboard={false}>
      <Form onSubmit={handleSubmit}>
        <Modal.Header closeButton>
          <Modal.Title>Dodaj košnicu</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          <Form.Group className="mb-3" controlId="formPcelinjakId">
            <Form.Label>Pčelinjak</Form.Label>
            <Form.Select
              name="pcelinjak_id"
